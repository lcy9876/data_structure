...
protected:
    ...
    struct BinaryNode
    {
         ...
         * @param ht 子树高度
         */
        BinaryNode(const Comparable &theElement, BinaryNode *lt, BinaryNode *rt, int ht = 1)
         ...
         * @param ht 子树高度
         */
        BinaryNode(Comparable &&theElement, BinaryNode *lt, BinaryNode *rt, int ht = 1)
            : element{ std::move(theElement) }, left{ lt }, right{ rt }, height{ ht } {}
    };
